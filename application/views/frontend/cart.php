                  ...
                  <td class="margin-respon rger">
                    <div class="col-xl-12 col-md-12 col-sm-12 " style="padding: 0px !important;">
                      <div class="custom-qty">
                        <button onclick="var result = document.getElementById('qty1'); var qty1 = result.value; if( !isNaN( qty1 ) &amp;&amp; qty1 > 1 ) result.value--;return false;" class="reduced items paa-ews" type="button"> <i class="fa fa-minus "></i> </button>
                        <input type="text" class="input-text qty voain-re" title="Qty" value="1" maxlength="8" id="qty1" name="qty" autocomplete="off">
