                      ...
                      <div class="product">
                        ...
                        <div class="product_img">
                          <a href="<?= base_url() ?>Home/product_detail/<?= $data->url ?>?type=<?= base64_encode($type_data[0]->id) ?>">
                            <img src="<?= base_url() . $type_data[0]->image ?>" onmouseover="pro_change(this)" onmouseout="pro_default(this)" img="<?= base_url() . $type_data[0]->image ?>" img2="<?= base_url() . $image1 ?>" alt="<?= $data->name ?>">
                          </a>
                          ...
                          ?>
                              <li>
                                <div class="custome-checkbox">
                                  <input class="form-check-input sizeCheck" type="checkbox" id="s<?= $size_filter[0]->id ?>" name="size[]" value="<?= $size_filter[0]->id ?>">
                          ...
                          ?>
                              <li>
                                <div class="custome-checkbox colorcheckboxess">
                                  <input class="form-check-input colorCheck" type="checkbox" id="c<?= $olor_filter[0]->id ?>" name="color[]" value="<?= $olor_filter[0]->id ?>">
                                  <label class="form-check-label colorcheckboxes" for="c<?= $olor_filter[0]->id ?>"><span data-color="<?= $olor_filter[0]->name ?>" class="colorspann"></span>
                                    <span style="width:100px;height:auto;font-size:14px;vertical-align:top;"><?= $olor_filter[0]->colour_name ?> </span>
                                  </label>
                                </div>
                              </li>
                          <? }
