...
<body>
            ...
            <div class="col-sm-12">
              <div class="popup_content pl-0 pr-0 pt-0">
                ...
                <form method="post" action="javascript:void(0)" id="loginForm" enctype="multipart/form-data" style="padding-left: 50px;padding-right: 50px;">
                  ...
                  <div class="text-center"><span class="mt-3">New Here?<a href="#" data-target="#onload-popup2" data-toggle="modal" data-dismiss="modal" style="color:#ff324d;">&nbsp;Sign Up</a></span>
                  </div>
  ...
  <!-- ======================================= START HEADER  =============================================================-->
  <header class="header_wrap" style="position: sticky; top: 0; z-index: 99999;">
    <div class="middle-header dark_skin">
      <div class="container-fluid">
        ...
        <div class="nav_block">
          <a class="desktoplogo" href="<?=base_url()?>" style="margin-left:30px;">
            <img class="logo_light d-block " src="<?=base_url()?>assets/frontend/images\logo2.png" alt="logo" width="40%">
          </a>
          ...
          <ul class="navbar-nav attr-nav align-items-center" id="headerCount">
            <li style="font-size: 12px;padding: 0px 10px;" class="dropdown cart_dropdown topicon" id="hoverCart">
              <?if(empty($this->session->userdata('user_data'))){?>
            ...
            <li style="font-size: 12px;" class="searchshow onclick"><a href="javascript:void(0)" class="nav-link" style="padding:0px 10px;"><i class="linearicons-magnifier" style="font-size: 17px;"></i></a><span class="sm_none">Search</span></li>
            ...
            if(!empty($this->session->userdata('user_data'))){
              ...
              ?>
            <li style="font-size: 12px;padding: 0px 10px;"><a href="<?=base_url()?>Home/my_wishlist" class="nav-link" style="padding:0px 10px;">
              <i class="linearicons-heart"></i><span class="wishlist_count"><?=$wishcount;?></span></a>
              <span class="sm_none">Wishlist</span></li>
              <?}else{?>
                <li style="font-size: 12px;padding: 0px 10px;"><a href="javascript:;" class="nav-link" data-target="#onload-popup1" data-toggle="modal" data-dismiss="modal" class="nav-link" style="padding:0px 10px;">
              <i class="linearicons-heart"></i><span class="wishlist_count"><?=$wishcount;?></span></a>
              <span class="sm_none">Wishlist</span></li>
                <?}?>
            <li class="dropdown cart_dropdown" id="mob_cart" style="position:inherit;font-size: 12px;">
              <? if(!empty($this->session->userdata('user_data'))){
              ...
              ?>
              <a class="nav-link cart_trigger" href="#" data-toggle="dropdown" id="carto" style="padding:0px; padding-left: 3px;"><i class="linearicons-bag2"></i><span class="cart_count"><?=$cartcount?></span></a>
              <span class="sm_none">Bag</span>
              <!-- ======================= START WEB MINI CART ====================  -->
              <div class="cart_box cart_right dropdown-menu dropdown-menu-right" id="minicart">
      ...
      <div class="container-fluid mobiledisplay">
        <form action="<?=base_url()?>Home/search" method="GET" enctype="multipart/form-data">
        <div class="input-group">
          <input class="form-control" placeholder="Search Product..." name="search" required="" type="text" style="height: 35px;">
          ...
          <div class="col-lg-12 col-md-8 col-sm-6 col-9">
            <nav class="navbar navbar-expand-lg" style="height:40px;">
              <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                <ul class="navbar-nav navv" style="margin-left:40px;">
                  <li style="padding:10px 10px; display: none;">User Name</li>
                  <li class="dropdown mobdrop" style="padding-left:50px;">
