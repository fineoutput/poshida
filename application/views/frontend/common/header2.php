            ...
            <div class="col-sm-12">
              <div class="popup_content pl-0 pr-0 pt-0">
                ...
                <form method="post" action="javascript:void(0)" id="loginForm" enctype="multipart/form-data" style="padding-left: 50px;padding-right: 50px;">
                  ...
                  <div class="text-center"><span class="mt-3">New Here?<a href="#" data-target="#onload-popup2" data-toggle="modal" data-dismiss="modal" style="color:#c68fa6;">&nbsp;Sign Up</a></span>
                  </div>
