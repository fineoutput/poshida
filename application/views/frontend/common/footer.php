...
<div class="container-fluid mobilebottom" style="position:sticky; bottom: 0;background:#f2f2f2;z-index: 9999;" id="footerCount">
	<div class="row" style="justify-content: space-between;">
		...
		<div class="col-2 text-center mt-2 p-0"><a href="index.html"><img src="../<?= base_url() ?>assets/frontend/frontend/zuhause.png"></a>
			<h6>Home</h6>
		</div>
		<div class="col-2 text-center mt-2 p-0"><a href="#" data-toggle="modal" data-target="#exampleModalCenter"><img src="../<?= base_url() ?>assets/frontend/frontend/benutzerprofil.png"></a>
			<h6>Login</h6>
		</div>
		<div class="col-2 text-center mt-2 p-0"><a href="wishlist.html"><img src="../<?= base_url() ?>assets/frontend/frontend/liebe (1).png"></a><span class="wishlist_count">0</span></a>
			<h6>Wishlist</h6>
		</div>
		<div class="col-2 text-center mt-2 p-0"><a href="cart.html">&nbsp;<img src="../<?= base_url() ?>assets/frontend/frontend/big-bag-mit-griffen.png"></i><span class="cart_count">0</span></a>
			<h6>Bag</h6>
		</div>
		<div class="col-2 text-center mt-2 p-0"><a href="contact.html" rel="noopener noreferrer"> <img src="../<?= base_url() ?>assets/frontend/frontend/whatsapp.png"></a>
		...
		<div class="modal-content">
			...
			<div class="popup_content pl-0 pr-0 pt-0">
				...
				<form method="post" action="javascript:void(0)" id="loginForm" enctype="multipart/form-data" style="padding-left: 20px;padding-right: 20px;">
					...
					<div class="container">
						<div class="row">
							<p style="margin-bottom: 3px;">By Continuing, I agree to the <a href="term-condition.html" style="color: #c68fa6;">Terms of use</a>
								&amp; <a href="privacy_policy.html" style="color: #c68fa6;">Privacy
									Policy</a></p>
						</div>
					</div>
					<div class="form-group">
