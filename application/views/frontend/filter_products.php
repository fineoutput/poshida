                      ...
                      <ul>
                        ...
                        ?>
                            <li>
                              <div class="check-box">
                                <span>
                                  <input type="checkbox" class="checkbox sizeCheck" <? if (!empty($sized)) {
                                                                                      if (in_array($size_filter[0]->id, $sized)) {
                                                                                        echo "checked";
                                                                                      }
                                                                                    } ?> id="s<?= $size_filter[0]->id ?>" name="size[]" value="<?= $size_filter[0]->id ?>">
                      ...
                      <ul>
                        ...
                        ?>
                            <li>
                              <div class="check-box">
                                <span>
                                  <input type="checkbox" class="checkbox colorCheck" <? if (!empty($color)) {
                                                                                        if (in_array($olor_filter[0]->id, $color)) {
                                                                                          echo "checked";
                                                                                        }
                                                                                      } ?> id="c<?= $olor_filter[0]->id ?>" name="color[]" value="<?= $olor_filter[0]->id ?>">
                          ...
                          <ul>
                            ...
                            ?>
                                <li>
                                  <div class="check-box">
                                    <span>
                                      <input type="checkbox" class="checkbox attribute<?= $filter->id ?>" <? if (!empty($attribute)) {
...
<div class="container-fluid mobilebottom" style="position:sticky; bottom: 0;background:#f2f2f2;" id="footerCount">
  <div class="row text-center">
    ...
    <div class="col-6 p-2">
      <a rel="canonical" href="#" data-target="#filter" data-toggle="modal" data-bs-dismiss="modal"> <img src="<?= base_url() ?>assets/frontend/img/filter.png" rel="icon"> FILTER</a>
    </div>
  </div>
            ...
            <div class="popup_content" style="padding: 0px 0px ;">
              <div class="row mt-2" style="margin-right: 0px; 
                ...
                <div class="col-6 fdghddf">
                  <a rel="canonical" href="<?= base_url() ?>products/<?= $url ?>/1" class="btn df">CLEAR ALL</a>
                </div>
                <div class="col-6 fdghddf">
                    ...
                    <div class="tab-content shop_info_tab" style="margin-top:5px;">
                      <div class="tab-pane show active" id="price" role="tabpanel" aria-labelledby="price-tab">
                        ...
                        <div class="filter_price hrtf   " style="    position: absolute;
                          ...
                          <div id="price_filter22" class="reset-price" data-min="0" data-max="5000" data-min-value="<?= $minvalue ?>" data-max-value="<?= $maxvalue ?>" data-price-sign="₹"></div>
                          <div class="price_range">
                      ...
                      <div class="tab-pane fade" id="color" role="tabpanel" aria-labelledby="color-tab">
                        ...
                        <ul class="list_brand mt-4" style="text-align: left;max-height:87vh;overflow:auto;">
                          ...
                          ?>
                              ...
                              <li>
                                <div class="custome-checkbox">
                                  <input class="form-check-input clearcolor colorCheck" <? if (!empty($color)) {
                                                                                          if (in_array($olor_filter[0]->id, $color)) {
                                                                                            echo "checked";
                                                                                          }
                                                                                        } ?> type="checkbox" name="color[]" id="color<?= $olor_filter[0]->id ?>" value="<?= $olor_filter[0]->id ?>">
