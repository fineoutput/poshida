            ...
            <div class="col-12">
              <div class="product_header">
                <div class="product_header_right" style="float: right;margin-right:20px; position: absolute; right: 21.5%;">
                  <li class="dropdown  sortbyhover" data-toggle="dropdown"><span style="font-size: 15px;">Sort By </span><span id="sort by">Price</span> <img src="<?= base_url() ?>assets\frontend\images\down-arrow.png" alt="" style="float: right;margin-top: 6px;">
                    <div class="cart_box cart_right dropdown-menu dropdown-menu-right" style="right: auto;margin-left: -10px;min-width: 14.3rem;">
                      <ul class="hovercolor">
                        <li onclick="soryBy('ASC')" class="<? if ($sort == 'ASC') {
                                                              echo 'first';
                                                            } ?>" style="color: black;">
                          Low to high
                        </li>
                        <li onclick="soryBy('DESC')" class="<? if ($sort == 'DESC') {
                                                              echo 'first';
                                                            } ?>" style="color: black;">
                          High to low
                        </li>
                          ...
                          ?>
                              <li>
                                <div class="custome-checkbox">
                                  <input class="form-check-input sizeCheck" <? if (!empty($sized)) {
                                                                              if (in_array($size_filter[0]->id, $sized)) {
                                                                                echo "checked";
                                                                              }
                                                                            } ?> type="checkbox" id="s<?= $size_filter[0]->id ?>" name="size[]" value="<?= $size_filter[0]->id ?>">
                      ...
                      <div class="card-body">
                        ...
                        <ul class="list_brand product_color_switch mt-4">
                          ...
                          ?>
                              <li>
                                <div class="custome-checkbox">
                                  <input class="form-check-input clearcolor" <? if (!empty($color)) {
                                                                                if (in_array($olor_filter[0]->id, $color)) {
                                                                                  echo "checked";
                                                                                }
                                                                              } ?> type="checkbox" id="c<?= $olor_filter[0]->id ?>" name="color[]" value="<?= $olor_filter[0]->id ?>">
                                  <label class="form-check-label colorChecks colorcheckboxes" for="c<?= $olor_filter[0]->id ?>"><span data-color="<?= $olor_filter[0]->name ?>" class="colorspann"></span> <?= $olor_filter[0]->colour_name ?></label>
                                </div>
                              </li>
                          <? }
                          } ?>
                          ...
                          <div class="card-body">
                            ...
                            <ul class="list_brand mt-4">
                              ...
                              ?>
                                  <li>
                                    <div class="custome-checkbox">
                                      <input class="form-check-input attribute<?= $filter->id ?>" type="checkbox" <? if (!empty($attribute)) {
                                                                                                                    if (in_array($attr->id, $attribute)) {
                                                                                                                      echo "checked";
                                                                                                                    }
                                ...
                                <li>
                                  <div class="custome-checkbox">
                                    <input class="form-check-input sizeCheck" <? if (!empty($sized)) {
                                                                              ...
                                                                              } ?> type="checkbox" name="size[]" id="size<?= $size_filter[0]->id ?>" value="<?= $size_filter[0]->id ?>">
                        ...
                        <div class="tab-pane fade" id="color" role="tabpanel" aria-labelledby="color-tab">
                          ...
                          <ul class="list_brand product_color_switch mt-4" style="text-align: left;max-height:82vh;overflow:auto;">
                            ...
                            ?>
                                <li>
                                  <div class="custome-checkbox">
                                    <input class="form-check-input clearcolor colorCheck" type="checkbox" name="color[]" <? if (!empty($color)) {
                                                                                                                            if (in_array($olor_filter[0]->id, $color)) {
                                                                                                                              echo "checked";
                                                                                                                            }
                                                                                                                          } ?> id="color<?= $olor_filter[0]->id ?>" value="<?= $olor_filter[0]->id ?>">
                                    <label class="form-check-label " for="color<?= $olor_filter[0]->id ?>"> <span data-color="<?= $olor_filter[0]->name ?>"></span><?= $olor_filter[0]->colour_name ?></label>
                                  </div>
                                </li>
                            <? }
                            } ?>
