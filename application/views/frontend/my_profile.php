...
<div class="main_content">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <div class="dashboard_menu">
            <ul class="nav nav-tabs flex-column" role="tablist">
              <!-- <li class="nav-item">
                <a class="nav-link " id="dashboard-tab" data-toggle="tab" href="#dash" role="tab" aria-controls="dashboard" aria-selected="false"><i class="ti-layout-grid2"></i>Dashboard</a>
              </li> -->
              <li class="nav-item">
                <a class="nav-link active" id="orders-tab" data-toggle="tab" href="#order" role="tab" aria-controls="orders" aria-selected="false"><i class="ti-shopping-cart-full"></i>Orders</a>
              </li>
              <li class="nav-item">
        ...
        <div class="col-lg-9 col-md-8" style="padding:0px 0px 1.25rem;">
          <div class="tab-content dashboard_content">
            ...
            <div class="tab-pane fade active show" id="order" role="tabpanel" aria-labelledby="orders-tab">
              <div class="card">
                <div class="card-header">
                  <h3>Orders</h3>
                </div>
  ...
  $type_data = $this->db->get_where('tbl_type', array('product_id = ' => $product_data[0]->id))->result();
     ?>
                        <tr>
                          <td class="product-thumbnail"><a href="<?=base_url()?>Home/product_detail/<?=$product_data[0]->url?>"><img src="<?=base_url().$type_data[0]->image?>" alt="<?=$product_data[0]->name?>"></a></td>
