...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url() ?>assets/frontend/img/logo_update.jpg" type="image/x-icon" />
  <title>Poshida By Ronak Textiles Invoice</title>
</head>
  ...
  <div class="container main_container">
    <div class="row">
      <div class="col-sm-6 oswal_logo">
        <img src="<?= base_url() ?>assets/frontend/img/logo_update.jpg" class="img-fluid" style="width:150px;">
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6"><span class="font-weight-bold ">Sold By</span><br>
          <span class="seller_details">Poshida By Ronak Textiles <br>
