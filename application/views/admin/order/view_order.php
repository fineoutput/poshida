<div class="content-wrapper">
  ...
  <section class="content">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php if (!empty($data->promocode)) {
                              echo "₹" . $data->promo_discount;
                            } else {
                              echo "NA";
                            } ?></td>
                        <? if ($order_type == 1) { ?>
                          <td><? if (!empty($data->shipping)) {
                                echo "₹" . $data->shipping;
                              } else {
                                echo "₹0";
                              } ?></td>
                        <? } else { ?>
                          <td><? if (!empty($data->percentage_discount)) {
                                echo "₹" . $data->percentage_discount;
                              } else {
                                echo "₹0";
                              } ?></td>
                        <? } ?>
                        ...
                        if (!empty($data->address_id)) {
                          $address_data = $this->db->get_where('tbl_user_address', array('id' => $data->address_id))->row();
    ...
    <li><a href="<?php echo base_url() ?>dcadmin/Order/updateorderStatus/<?php echo base64_encode($data->id) ?>/reject">Rejected</a></li> -->
                                  ...
                                  <li><a href="<?php echo base_url() ?>dcadmin/order/order_detail/<?php echo base64_encode($data->id) ?><? if ($order_type = 2) {
