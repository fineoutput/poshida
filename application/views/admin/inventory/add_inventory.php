      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url()  ?>dcadmin/inventory/add_inventory_data/<? echo base64_encode(2);  ?>/<?=$product_id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                     ...
                     <?php  } ?>
                      <td> <strong>Stock <?php
                                          if ($product_unit_type == 1) {
                                            echo " ( ex : 1 for 1kg , 0.5 for 500 gram)";
                                          }
