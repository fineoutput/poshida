...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>dcadmin/Percentage_off/add_percentage_off_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
